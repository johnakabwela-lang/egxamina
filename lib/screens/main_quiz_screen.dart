...
class _QuizScreenState extends State<QuizScreen> {
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [Colors.green.shade400, Color(0xFF58CC02)],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color(0xFF58CC02), // Duolingo green background
      body: SafeArea(
        child: Column(
          children: [
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            child: Icon(Icons.school, color: Color(0xFF58CC02), size: 24),
          ),
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    colors: percentage >= 70
                        ? [Colors.green.shade400, Color(0xFF58CC02)]
                        : percentage >= 50
